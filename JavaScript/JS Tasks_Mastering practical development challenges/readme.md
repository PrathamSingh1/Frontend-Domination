1. Create an HTML page with a button. When the button is clicked, change the text of paragraph element.
...
5. Build a countdown timer that starts when a button is clicked and updates the display in reat-time.
...
9. Build a characher counter for a text area or input field, which updates in real-time as the types and enforces a character limit.
